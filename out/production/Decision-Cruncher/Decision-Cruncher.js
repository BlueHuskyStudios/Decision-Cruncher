...
this['Decision-Cruncher'] = function (_, Kotlin) {
  ...
  AlertOption$close.prototype = Object.create(AlertOption.prototype);
  AlertOption$close.prototype.constructor = AlertOption$close;
  AlertOption$yes.prototype = Object.create(AlertOption.prototype);
  AlertOption$yes.prototype.constructor = AlertOption$yes;
  AlertOption$no.prototype = Object.create(AlertOption.prototype);
  AlertOption$no.prototype.constructor = AlertOption$no;
  AlertOption$cancel.prototype = Object.create(AlertOption.prototype);
  AlertOption$cancel.prototype.constructor = AlertOption$cancel;
  AlertOption$ok.prototype = Object.create(AlertOption.prototype);
  AlertOption$ok.prototype.constructor = AlertOption$ok;
  HuskyOptionPaneOptionType.prototype = Object.create(Enum.prototype);
  HuskyOptionPaneOptionType.prototype.constructor = HuskyOptionPaneOptionType;
  HuskyOptionPaneMessageType.prototype = Object.create(Enum.prototype);
  HuskyOptionPaneMessageType.prototype.constructor = HuskyOptionPaneMessageType;
  Axis1D.prototype = Object.create(Enum.prototype);
  Axis1D.prototype.constructor = Axis1D;
  Axis2D.prototype = Object.create(Enum.prototype);
  Axis2D.prototype.constructor = Axis2D;
  Axis3D.prototype = Object.create(Enum.prototype);
  Axis3D.prototype.constructor = Axis3D;
  AxisOrientation.prototype = Object.create(Enum.prototype);
  AxisOrientation.prototype.constructor = AxisOrientation;
  UIAnchor$minXminY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$minXminY.prototype.constructor = UIAnchor$minXminY;
  UIAnchor$midXminY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$midXminY.prototype.constructor = UIAnchor$midXminY;
  UIAnchor$maxXminY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$maxXminY.prototype.constructor = UIAnchor$maxXminY;
  UIAnchor$minXmidY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$minXmidY.prototype.constructor = UIAnchor$minXmidY;
  UIAnchor$midXmidY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$midXmidY.prototype.constructor = UIAnchor$midXmidY;
  UIAnchor$maxXmidY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$maxXmidY.prototype.constructor = UIAnchor$maxXmidY;
  UIAnchor$minXmaxY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$minXmaxY.prototype.constructor = UIAnchor$minXmaxY;
  UIAnchor$midXmaxY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$midXmaxY.prototype.constructor = UIAnchor$midXmaxY;
  UIAnchor$maxXmaxY.prototype = Object.create(UIAnchor.prototype);
  UIAnchor$maxXmaxY.prototype.constructor = UIAnchor$maxXmaxY;
  UISize.prototype = Object.create(Enum.prototype);
  UISize.prototype.constructor = UISize;
  ...
  Object.defineProperty(IntersectionDescription$leftVertexTouchesRightVertex.prototype, 'fractionValue', {
    get: function () {
      return new IntersectionDescription$leftVertexTouchesRightVertex(get_fractionValue_0(this.verticesLocation), this.isLeftStartVertex, this.isRightStartVertex);
    }
  });
  IntersectionDescription$leftVertexTouchesRightVertex.prototype.integerValue_i07jsf$$default = function (rounding) {
    return new IntersectionDescription$leftVertexTouchesRightVertex(integerValue_0(this.verticesLocation, rounding), this.isLeftStartVertex, this.isRightStartVertex);
  };
  ...
  Object.defineProperty(IntersectionDescription$leftVertexTouchesRightEdge.prototype, 'fractionValue', {
    get: function () {
      return new IntersectionDescription$leftVertexTouchesRightEdge(get_fractionValue_0(this.leftVertexLocation), this.isLeftStartVertex);
    }
  });
  IntersectionDescription$leftVertexTouchesRightEdge.prototype.integerValue_i07jsf$$default = function (rounding) {
    return new IntersectionDescription$leftVertexTouchesRightEdge(integerValue_0(this.leftVertexLocation, rounding), this.isLeftStartVertex);
  };
  ...
  Object.defineProperty(IntersectionDescription$rightVertexTouchesLeftEdge.prototype, 'fractionValue', {
    get: function () {
      return new IntersectionDescription$rightVertexTouchesLeftEdge(get_fractionValue_0(this.rightVertexLocation), this.isRightStartVertex);
    }
  });
  IntersectionDescription$rightVertexTouchesLeftEdge.prototype.integerValue_i07jsf$$default = function (rounding) {
    return new IntersectionDescription$rightVertexTouchesLeftEdge(integerValue_0(this.rightVertexLocation, rounding), this.isRightStartVertex);
  };
  ...
  Object.defineProperty(IntersectionDescription$edgesCross.prototype, 'fractionValue', {
    get: function () {
      return new IntersectionDescription$edgesCross(get_fractionValue_0(this.crossingLocation));
    }
  });
  IntersectionDescription$edgesCross.prototype.integerValue_i07jsf$$default = function (rounding) {
    return new IntersectionDescription$edgesCross(integerValue_0(this.crossingLocation, rounding));
  };
  ...
  IntegerLineSegment.prototype.contains_5eviog$ = function (point, tolerance) {
    var tmp$;
    var integerPoint = get_integerValue_1(point);
  ...
  IntegerLineSegment$Companion.prototype.findLineIntersection_3akoz3$ = function (line1, line2, tolerance) {
    if (tolerance === void 0)
      tolerance = defaultIntegerCalculationTolerance;
    var tmp$;
    return (tmp$ = get_fractionValue(line1).rawIntersection_eu7yk7$(get_fractionValue(line2), numberToDouble(tolerance))) != null ? get_integerValue_1(tmp$) : null;
  };
  ...
  function get_integerValue($receiver) {
    var tmp$, tmp$_0;
    return (tmp$_0 = Kotlin.isType(tmp$ = $receiver, IntegerLineSegment) ? tmp$ : null) != null ? tmp$_0 : new IntegerLineSegment(get_integerValue_1($receiver.start), get_integerValue_1($receiver.end));
  }
  function integerValue($receiver, rounding) {
    if (rounding === void 0)
      rounding = RoundingDirection$Companion_getInstance().default;
    var tmp$, tmp$_0;
    return (tmp$_0 = Kotlin.isType(tmp$ = $receiver, IntegerLineSegment) ? tmp$ : null) != null ? tmp$_0 : new IntegerLineSegment(integerValue_0($receiver.start, rounding), integerValue_0($receiver.end, rounding));
  }
  ...
  FractionLineSegment.prototype.contains_5eviog$ = function (point, tolerance) {
    var tmp$;
    var fractionPoint = get_fractionValue_0(point);
  ...
  function get_fractionValue($receiver) {
    var tmp$, tmp$_0;
    return (tmp$_0 = Kotlin.isType(tmp$ = $receiver, FractionLineSegment) ? tmp$ : null) != null ? tmp$_0 : new FractionLineSegment(get_fractionValue_0($receiver.start), get_fractionValue_0($receiver.end));
  }
  function Path() {
  }
  Path.$metadata$ = {
  ...
  function IntegerPath$Companion$segmentsFromGenericPoints$lambda(previousSegments, currentPoint) {
    previousSegments.add_11rb$(new IntegerLineSegment(last(previousSegments).end, get_integerValue_1(currentPoint)));
  ...
  IntegerPath$Companion.prototype.segmentsFromGenericPoints_58xfhi$ = function (points, isClosed) {
    ...
    var runningValue = {v: mutableListOf([new IntegerLineSegment(get_integerValue_1(points.get_za3lpa$(0)), get_integerValue_1(points.get_za3lpa$(1)))])};
    var tmp$;
    ...
    if (isClosed) {
      var element_0 = new IntegerLineSegment(get_integerValue_1(last(points)), get_integerValue_1(first(points)));
  ...
  function IntegerPath$Companion$pathFromGenericSegments$lambda(translatedSegments, currentSegment) {
    var integerSegment = get_integerValue(currentSegment);
  ...
  function get_integerValue_0($receiver) {
    var tmp$, tmp$_0;
  ...
  function get_integerValue_1($receiver) {
    var tmp$, tmp$_0;
  ...
  function integerValue_0($receiver, rounding) {
    if (rounding === void 0)
      rounding = RoundingDirection$Companion_getInstance().default;
    var tmp$, tmp$_0;
    return (tmp$_0 = Kotlin.isType(tmp$ = $receiver, IntegerPoint) ? tmp$ : null) != null ? tmp$_0 : new IntegerPoint(integerValue_1($receiver.x, rounding), integerValue_1($receiver.y, rounding));
  }
  function get_fractionValue_0($receiver) {
    var tmp$, tmp$_0;
  ...
  IntegerRect.prototype.expanded_2aye5d$ = function (toInclude) {
    return get_integerValue_2(ComputableRect.prototype.expanded_2aye5d$.call(this, toInclude));
  };
  ...
  function get_integerValue_2($receiver) {
    var tmp$, tmp$_0;
  ...
  FractionRect.prototype.expanded_2aye5d$ = function (toInclude) {
    return get_fractionValue_1(ComputableRect.prototype.expanded_2aye5d$.call(this, toInclude));
  };
  ...
  function get_fractionValue_1($receiver) {
    var tmp$, tmp$_0;
  ...
  function get_integerValue_3($receiver) {
    return new IntegerSize(toInt64Checked($receiver.width), toInt64Checked($receiver.height));
  }
  var get_fractionValue_2 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.geometry.get_fractionValue_6z9w7d$', wrapFunction(function () {
  ...
  var get_fractionValue_3 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_fractionValue_rtoihn$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return numberToDouble($receiver);
    };
  }));
  var get_fractionValue_4 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_fractionValue_yrwdxr$', function ($receiver) {
    return $receiver;
  });
  ...
  var toInt8Checked_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt8Checked_mz3mee$', function ($receiver) {
    return $receiver;
  });
  var toInt8Checked_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt8Checked_5vcgdc$', wrapFunction(function () {
    var toByte = Kotlin.toByte;
    return function ($receiver) {
      return toByte($receiver);
    };
  }));
  var toInt8Checked_2 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt8Checked_s8ev3n$', wrapFunction(function () {
    var toByte = Kotlin.toByte;
    return function ($receiver) {
      return toByte($receiver);
    };
  }));
  var toInt8Checked_3 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt8Checked_mts6qi$', wrapFunction(function () {
    var toByte = Kotlin.toByte;
    return function ($receiver) {
      return toByte($receiver.toInt());
    };
  ...
  var toInt16Checked_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt16Checked_5vcgdc$', function ($receiver) {
    return $receiver;
  });
  var toInt16Checked_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt16Checked_mz3mee$', function ($receiver) {
    return $receiver;
  });
  var toInt16Checked_2 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt16Checked_s8ev3n$', wrapFunction(function () {
    var toShort = Kotlin.toShort;
    return function ($receiver) {
      return toShort($receiver);
    };
  }));
  var toInt16Checked_3 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt16Checked_mts6qi$', wrapFunction(function () {
    var toShort = Kotlin.toShort;
    return function ($receiver) {
      return toShort($receiver.toInt());
    };
  ...
  var toInt32Checked_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt32Checked_s8ev3n$', function ($receiver) {
    return $receiver;
  });
  var toInt32Checked_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt32Checked_mz3mee$', function ($receiver) {
    return $receiver;
  });
  var toInt32Checked_2 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt32Checked_5vcgdc$', function ($receiver) {
    return $receiver;
  });
  var toInt32Checked_3 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt32Checked_mts6qi$', function ($receiver) {
    return $receiver.toInt();
  });
  ...
  var toInt64Checked_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt64Checked_mts6qi$', function ($receiver) {
    return $receiver;
  });
  var toInt64Checked_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt64Checked_mz3mee$', function ($receiver) {
    return Kotlin.Long.fromInt($receiver);
  });
  var toInt64Checked_2 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt64Checked_5vcgdc$', function ($receiver) {
    return Kotlin.Long.fromInt($receiver);
  });
  var toInt64Checked_3 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInt64Checked_s8ev3n$', function ($receiver) {
    return Kotlin.Long.fromInt($receiver);
  });
  var toInteger = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInteger_mts6qi$', function ($receiver) {
    return $receiver;
  });
  var toInteger_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInteger_rtoihn$', wrapFunction(function () {
    var numberToLong = Kotlin.numberToLong;
    return function ($receiver) {
      return numberToLong($receiver);
    };
  }));
  var toFloat32 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFloat32_81szk$', function ($receiver) {
    return $receiver;
  });
  var toFloat32_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFloat32_rtoihn$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return numberToDouble($receiver);
    };
  }));
  var toFloat64 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFloat64_yrwdxr$', function ($receiver) {
    return $receiver;
  });
  var toFloat64_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFloat64_rtoihn$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return numberToDouble($receiver);
    };
  }));
  var toFraction = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFraction_yrwdxr$', function ($receiver) {
    return $receiver;
  });
  var toFraction_0 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFraction_rtoihn$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return numberToDouble($receiver);
    };
  ...
  var toInteger_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toInteger_baug4k$', wrapFunction(function () {
    var toLong = Kotlin.kotlin.text.toLong_6ic1pp$;
    return function ($receiver, radix) {
      if (radix === void 0)
        radix = 10;
  ...
  var toFloat32_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFloat32_pdl1vz$', wrapFunction(function () {
    var toDouble = Kotlin.kotlin.text.toDouble_pdl1vz$;
    return function ($receiver) {
      return toDouble($receiver);
    };
  }));
  var toFloat64_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFloat64_pdl1vz$', wrapFunction(function () {
    var toDouble = Kotlin.kotlin.text.toDouble_pdl1vz$;
    return function ($receiver) {
      return toDouble($receiver);
    };
  }));
  var toFraction_1 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.toFraction_pdl1vz$', wrapFunction(function () {
    var toDouble = Kotlin.kotlin.text.toDouble_pdl1vz$;
    return function ($receiver) {
      return toDouble($receiver);
    };
  ...
  var get_integerValue_4 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_integerValue_rtoihn$', wrapFunction(function () {
    var toInt64Checked = _.org.bh.tools.base.math.toInt64Checked_rtoihn$;
    return function ($receiver) {
      return toInt64Checked($receiver);
    };
  }));
  var get_integerValue_5 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_integerValue_mts6qi$', function ($receiver) {
    return $receiver;
  });
  function integerValue_1($receiver, rounded_0) {
    if (rounded_0 === void 0)
  ...
  function integerValue_4($receiver, rounded) {
    throw IllegalStateException_init('Not implemented on-purpose'.toString());
  }
  function integerValue_5($receiver, rounded) {
    throw IllegalStateException_init('Not implemented on-purpose'.toString());
  }
  ...
  var get_integerValue_6 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_integerValue_964n91$', wrapFunction(function () {
    var wrapFunction = Kotlin.wrapFunction;
    var get_int64Value$lambda = wrapFunction(function () {
      var toInt64Checked = _.org.bh.tools.base.math.toInt64Checked_rtoihn$;
      return function (it) {
  ...
  var get_integerValue_7 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_integerValue_i2lc79$', wrapFunction(function () {
    var wrapFunction = Kotlin.wrapFunction;
    var get_int64Value$lambda = wrapFunction(function () {
      var toInt64Checked = _.org.bh.tools.base.math.toInt64Checked_rtoihn$;
      return function (it) {
  ...
  var get_integerValue_8 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_integerValue_tmsbgo$', wrapFunction(function () {
    var wrapFunction = Kotlin.wrapFunction;
    var get_int64Value$lambda = wrapFunction(function () {
      var toInt64Checked = _.org.bh.tools.base.math.toInt64Checked_rtoihn$;
      return function (it) {
  ...
  var get_integerValue_9 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_integerValue_se6h4x$', function ($receiver) {
    return $receiver;
  });
  ...
  var get_fractionValue_5 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_fractionValue_rjqryz$', wrapFunction(function () {
    var wrapFunction = Kotlin.wrapFunction;
    var get_float64Value$lambda = wrapFunction(function () {
      var numberToDouble = Kotlin.numberToDouble;
      return function (it) {
  ...
  var get_fractionValue_6 = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.math.get_fractionValue_bvy38s$', function ($receiver) {
    return $receiver;
  });
  ...
  CssHtmlAttributeWithValue.prototype.cssSelectorString_qyu2k8$ = function (parameter) {
  ...
  function CssClass(className) {
    ...
    this.htmlAttributeName_rt1rs9$_0 = lazy(CssClass$htmlAttributeName$lambda);
    this.cssSelectorString_dzy8io$_0 = lazy(CssClass$cssSelectorString$lambda(this));
  }
  Object.defineProperty(CssClass.prototype, 'htmlAttributeName', {
    get: function () {
      return this.htmlAttributeName_rt1rs9$_0.value;
    }
  });
  Object.defineProperty(CssClass.prototype, 'cssSelectorString', {
    get: function () {
      return this.cssSelectorString_dzy8io$_0.value;
    }
  });
  ...
  function CssId(idName) {
    this.idName = idName;
    this.htmlAttributeName_wgzbf6$_0 = lazy(CssId$htmlAttributeName$lambda);
    this.cssSelectorString_9c0ovr$_0 = lazy(CssId$cssSelectorString$lambda(this));
  }
  Object.defineProperty(CssId.prototype, 'htmlAttributeName', {
    get: function () {
      return this.htmlAttributeName_wgzbf6$_0.value;
    }
  });
  Object.defineProperty(CssId.prototype, 'cssSelectorString', {
    get: function () {
      return this.cssSelectorString_9c0ovr$_0.value;
    }
  });
  ...
  function DataAttribute(dataName) {
    ...
    this.htmlAttributeName_aenja2$_0 = lazy(DataAttribute$htmlAttributeName$lambda(this));
  }
  Object.defineProperty(DataAttribute.prototype, 'htmlAttributeName', {
    get: function () {
      return this.htmlAttributeName_aenja2$_0.value;
    }
  });
  ...
  var or = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.jsShim.or_ao9li5$', wrapFunction(function () {
    var SelectorCombiner$SelectorCombiner$either_init = _.org.bh.tools.base.jsShim.SelectorCombiner.either;
    return function ($receiver, rhs) {
      return new SelectorCombiner$SelectorCombiner$either_init($receiver, rhs);
    };
  }));
  var containing = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.jsShim.containing_ao9li5$', wrapFunction(function () {
    var SelectorCombiner$SelectorCombiner$container_init = _.org.bh.tools.base.jsShim.SelectorCombiner.container;
    return function ($receiver, child) {
      return new SelectorCombiner$SelectorCombiner$container_init($receiver, child);
    };
  }));
  var justBefore = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.jsShim.justBefore_ao9li5$', wrapFunction(function () {
    var SelectorCombiner$SelectorCombiner$immediateSibling_init = _.org.bh.tools.base.jsShim.SelectorCombiner.immediateSibling;
    return function ($receiver, brother) {
      return new SelectorCombiner$SelectorCombiner$immediateSibling_init($receiver, brother);
    };
  }));
  var before = defineInlineFunction('Decision-Cruncher.org.bh.tools.base.jsShim.before_ao9li5$', wrapFunction(function () {
    var SelectorCombiner$SelectorCombiner$sibling_init = _.org.bh.tools.base.jsShim.SelectorCombiner.sibling;
    return function ($receiver, brother) {
  ...
  function AlertOption(displayName) {
    this.displayName = displayName;
  }
  function AlertOption$close() {
    AlertOption$close_instance = this;
    AlertOption.call(this, 'Close');
  }
  AlertOption$close.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'close',
    interfaces: [AlertOption]
  };
  var AlertOption$close_instance = null;
  function AlertOption$close_getInstance() {
    if (AlertOption$close_instance === null) {
      new AlertOption$close();
    }
    return AlertOption$close_instance;
  }
  function AlertOption$yes() {
    AlertOption$yes_instance = this;
    AlertOption.call(this, 'Yes');
  }
  AlertOption$yes.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'yes',
    interfaces: [AlertOption]
  };
  var AlertOption$yes_instance = null;
  function AlertOption$yes_getInstance() {
    if (AlertOption$yes_instance === null) {
      new AlertOption$yes();
    }
    return AlertOption$yes_instance;
  }
  function AlertOption$no() {
    AlertOption$no_instance = this;
    AlertOption.call(this, 'No');
  }
  AlertOption$no.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'no',
    interfaces: [AlertOption]
  };
  var AlertOption$no_instance = null;
  function AlertOption$no_getInstance() {
    if (AlertOption$no_instance === null) {
      new AlertOption$no();
    }
    return AlertOption$no_instance;
  }
  function AlertOption$cancel() {
    AlertOption$cancel_instance = this;
    AlertOption.call(this, 'Cancel');
  }
  AlertOption$cancel.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'cancel',
    interfaces: [AlertOption]
  };
  var AlertOption$cancel_instance = null;
  function AlertOption$cancel_getInstance() {
    if (AlertOption$cancel_instance === null) {
      new AlertOption$cancel();
    }
    return AlertOption$cancel_instance;
  }
  function AlertOption$ok() {
    AlertOption$ok_instance = this;
    AlertOption.call(this, 'OK');
  }
  AlertOption$ok.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'ok',
    interfaces: [AlertOption]
  };
  var AlertOption$ok_instance = null;
  function AlertOption$ok_getInstance() {
    if (AlertOption$ok_instance === null) {
      new AlertOption$ok();
    }
    return AlertOption$ok_instance;
  }
  AlertOption.prototype.toString = function () {
    return this.displayName;
  };
  AlertOption.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AlertOption',
    interfaces: []
  };
  function UserPrompt() {
  }
  UserPrompt.prototype.showOptionDialog_fym2km$ = function (parentComponent, title, message, messageType, optionType, allOptions, defaultOption, onUserSelection, callback$default) {
    if (parentComponent === void 0)
      parentComponent = null;
    if (messageType === void 0)
      messageType = HuskyOptionPaneMessageType$plain_getInstance();
    if (optionType === void 0)
      optionType = HuskyOptionPaneOptionType$default_getInstance();
    if (allOptions === void 0)
      allOptions = optionType.defaultAlertOptions;
    if (defaultOption === void 0)
      defaultOption = null;
    callback$default ? callback$default(parentComponent, title, message, messageType, optionType, allOptions, defaultOption, onUserSelection) : this.showOptionDialog_fym2km$$default(parentComponent, title, message, messageType, optionType, allOptions, defaultOption, onUserSelection);
  };
  UserPrompt.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'UserPrompt',
    interfaces: []
  };
  function HuskyOptionPaneOptionType(name, ordinal) {
    Enum.call(this);
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function HuskyOptionPaneOptionType_initFields() {
    HuskyOptionPaneOptionType_initFields = function () {
    };
    HuskyOptionPaneOptionType$default_instance = new HuskyOptionPaneOptionType('default', 0);
    HuskyOptionPaneOptionType$yesNo_instance = new HuskyOptionPaneOptionType('yesNo', 1);
    HuskyOptionPaneOptionType$yesNoCancel_instance = new HuskyOptionPaneOptionType('yesNoCancel', 2);
    HuskyOptionPaneOptionType$okCancel_instance = new HuskyOptionPaneOptionType('okCancel', 3);
    HuskyOptionPaneOptionType$ok_instance = new HuskyOptionPaneOptionType('ok', 4);
  }
  var HuskyOptionPaneOptionType$default_instance;
  function HuskyOptionPaneOptionType$default_getInstance() {
    HuskyOptionPaneOptionType_initFields();
    return HuskyOptionPaneOptionType$default_instance;
  }
  var HuskyOptionPaneOptionType$yesNo_instance;
  function HuskyOptionPaneOptionType$yesNo_getInstance() {
    HuskyOptionPaneOptionType_initFields();
    return HuskyOptionPaneOptionType$yesNo_instance;
  }
  var HuskyOptionPaneOptionType$yesNoCancel_instance;
  function HuskyOptionPaneOptionType$yesNoCancel_getInstance() {
    HuskyOptionPaneOptionType_initFields();
    return HuskyOptionPaneOptionType$yesNoCancel_instance;
  }
  var HuskyOptionPaneOptionType$okCancel_instance;
  function HuskyOptionPaneOptionType$okCancel_getInstance() {
    HuskyOptionPaneOptionType_initFields();
    return HuskyOptionPaneOptionType$okCancel_instance;
  }
  var HuskyOptionPaneOptionType$ok_instance;
  function HuskyOptionPaneOptionType$ok_getInstance() {
    HuskyOptionPaneOptionType_initFields();
    return HuskyOptionPaneOptionType$ok_instance;
  }
  Object.defineProperty(HuskyOptionPaneOptionType.prototype, 'defaultAlertOptions', {
    get: function () {
      switch (this.name) {
        case 'default':
        case 'ok':
          return listOf_0(AlertOption$ok_getInstance());
        case 'yesNo':
          return listOf([AlertOption$yes_getInstance(), AlertOption$no_getInstance()]);
        case 'yesNoCancel':
          return listOf([AlertOption$yes_getInstance(), AlertOption$no_getInstance(), AlertOption$cancel_getInstance()]);
        case 'okCancel':
          return listOf([AlertOption$ok_getInstance(), AlertOption$cancel_getInstance()]);
        default:return Kotlin.noWhenBranchMatched();
      }
    }
  });
  HuskyOptionPaneOptionType.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'HuskyOptionPaneOptionType',
    interfaces: [Enum]
  };
  function HuskyOptionPaneOptionType$values() {
    return [HuskyOptionPaneOptionType$default_getInstance(), HuskyOptionPaneOptionType$yesNo_getInstance(), HuskyOptionPaneOptionType$yesNoCancel_getInstance(), HuskyOptionPaneOptionType$okCancel_getInstance(), HuskyOptionPaneOptionType$ok_getInstance()];
  }
  HuskyOptionPaneOptionType.values = HuskyOptionPaneOptionType$values;
  function HuskyOptionPaneOptionType$valueOf(name) {
    switch (name) {
      case 'default':
        return HuskyOptionPaneOptionType$default_getInstance();
      case 'yesNo':
        return HuskyOptionPaneOptionType$yesNo_getInstance();
      case 'yesNoCancel':
        return HuskyOptionPaneOptionType$yesNoCancel_getInstance();
      case 'okCancel':
        return HuskyOptionPaneOptionType$okCancel_getInstance();
      case 'ok':
        return HuskyOptionPaneOptionType$ok_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.alert.HuskyOptionPaneOptionType.' + name);
    }
  }
  HuskyOptionPaneOptionType.valueOf_61zpoe$ = HuskyOptionPaneOptionType$valueOf;
  function HuskyOptionPaneMessageType(name, ordinal) {
    Enum.call(this);
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function HuskyOptionPaneMessageType_initFields() {
    HuskyOptionPaneMessageType_initFields = function () {
    };
    HuskyOptionPaneMessageType$plain_instance = new HuskyOptionPaneMessageType('plain', 0);
    HuskyOptionPaneMessageType$info_instance = new HuskyOptionPaneMessageType('info', 1);
    HuskyOptionPaneMessageType$question_instance = new HuskyOptionPaneMessageType('question', 2);
    HuskyOptionPaneMessageType$warning_instance = new HuskyOptionPaneMessageType('warning', 3);
    HuskyOptionPaneMessageType$error_instance = new HuskyOptionPaneMessageType('error', 4);
  }
  var HuskyOptionPaneMessageType$plain_instance;
  function HuskyOptionPaneMessageType$plain_getInstance() {
    HuskyOptionPaneMessageType_initFields();
    return HuskyOptionPaneMessageType$plain_instance;
  }
  var HuskyOptionPaneMessageType$info_instance;
  function HuskyOptionPaneMessageType$info_getInstance() {
    HuskyOptionPaneMessageType_initFields();
    return HuskyOptionPaneMessageType$info_instance;
  }
  var HuskyOptionPaneMessageType$question_instance;
  function HuskyOptionPaneMessageType$question_getInstance() {
    HuskyOptionPaneMessageType_initFields();
    return HuskyOptionPaneMessageType$question_instance;
  }
  var HuskyOptionPaneMessageType$warning_instance;
  function HuskyOptionPaneMessageType$warning_getInstance() {
    HuskyOptionPaneMessageType_initFields();
    return HuskyOptionPaneMessageType$warning_instance;
  }
  var HuskyOptionPaneMessageType$error_instance;
  function HuskyOptionPaneMessageType$error_getInstance() {
    HuskyOptionPaneMessageType_initFields();
    return HuskyOptionPaneMessageType$error_instance;
  }
  HuskyOptionPaneMessageType.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'HuskyOptionPaneMessageType',
    interfaces: [Enum]
  };
  function HuskyOptionPaneMessageType$values() {
    return [HuskyOptionPaneMessageType$plain_getInstance(), HuskyOptionPaneMessageType$info_getInstance(), HuskyOptionPaneMessageType$question_getInstance(), HuskyOptionPaneMessageType$warning_getInstance(), HuskyOptionPaneMessageType$error_getInstance()];
  }
  HuskyOptionPaneMessageType.values = HuskyOptionPaneMessageType$values;
  function HuskyOptionPaneMessageType$valueOf(name) {
    switch (name) {
      case 'plain':
        return HuskyOptionPaneMessageType$plain_getInstance();
      case 'info':
        return HuskyOptionPaneMessageType$info_getInstance();
      case 'question':
        return HuskyOptionPaneMessageType$question_getInstance();
      case 'warning':
        return HuskyOptionPaneMessageType$warning_getInstance();
      case 'error':
        return HuskyOptionPaneMessageType$error_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.alert.HuskyOptionPaneMessageType.' + name);
    }
  }
  HuskyOptionPaneMessageType.valueOf_61zpoe$ = HuskyOptionPaneMessageType$valueOf;
  function UIEvent() {
  }
  UIEvent.$metadata$ = {
    kind: Kind_INTERFACE,
  ...
  function Axis1D(name, ordinal, javaSwingOrientation) {
    if (javaSwingOrientation === void 0)
      javaSwingOrientation = AxisOrientation$euclidean_getInstance();
    Enum.call(this);
    this.javaSwingOrientation_lw17o8$_0 = javaSwingOrientation;
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function Axis1D_initFields() {
    Axis1D_initFields = function () {
    };
    Axis1D$x_instance = new Axis1D('x', 0);
  }
  Object.defineProperty(Axis1D.prototype, 'javaSwingOrientation', {
    get: function () {
      return this.javaSwingOrientation_lw17o8$_0;
    }
  });
  var Axis1D$x_instance;
  function Axis1D$x_getInstance() {
    Axis1D_initFields();
    return Axis1D$x_instance;
  }
  Axis1D.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Axis1D',
    interfaces: [Axis, Enum]
  };
  function Axis1D$values() {
    return [Axis1D$x_getInstance()];
  }
  Axis1D.values = Axis1D$values;
  function Axis1D$valueOf(name) {
    switch (name) {
      case 'x':
        return Axis1D$x_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.generic.geometry.Axis1D.' + name);
    }
  }
  Axis1D.valueOf_61zpoe$ = Axis1D$valueOf;
  function Axis2D(name, ordinal, javaSwingOrientation) {
    if (javaSwingOrientation === void 0)
      javaSwingOrientation = AxisOrientation$euclidean_getInstance();
    Enum.call(this);
    this.javaSwingOrientation_mzxeex$_0 = javaSwingOrientation;
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function Axis2D_initFields() {
    Axis2D_initFields = function () {
    };
    Axis2D$x_instance = new Axis2D('x', 0);
    Axis2D$y_instance = new Axis2D('y', 1, AxisOrientation$flipped_getInstance());
  }
  Object.defineProperty(Axis2D.prototype, 'javaSwingOrientation', {
    get: function () {
      return this.javaSwingOrientation_mzxeex$_0;
    }
  });
  var Axis2D$x_instance;
  function Axis2D$x_getInstance() {
    Axis2D_initFields();
    return Axis2D$x_instance;
  }
  var Axis2D$y_instance;
  function Axis2D$y_getInstance() {
    Axis2D_initFields();
    return Axis2D$y_instance;
  }
  Axis2D.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Axis2D',
  ...
  function Axis2D$values() {
    return [Axis2D$x_getInstance(), Axis2D$y_getInstance()];
  }
  Axis2D.values = Axis2D$values;
  function Axis2D$valueOf(name) {
    switch (name) {
      case 'x':
        return Axis2D$x_getInstance();
      case 'y':
        return Axis2D$y_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.generic.geometry.Axis2D.' + name);
    }
  }
  Axis2D.valueOf_61zpoe$ = Axis2D$valueOf;
  function Axis3D(name, ordinal, javaSwingOrientation) {
    if (javaSwingOrientation === void 0)
      javaSwingOrientation = AxisOrientation$euclidean_getInstance();
    Enum.call(this);
    this.javaSwingOrientation_o3tl5m$_0 = javaSwingOrientation;
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function Axis3D_initFields() {
    ...
    Axis3D$x_instance = new Axis3D('x', 0);
    Axis3D$y_instance = new Axis3D('y', 1);
    Axis3D$z_instance = new Axis3D('z', 2);
  }
  Object.defineProperty(Axis3D.prototype, 'javaSwingOrientation', {
    get: function () {
      return this.javaSwingOrientation_o3tl5m$_0;
    }
  });
  var Axis3D$x_instance;
  function Axis3D$x_getInstance() {
    Axis3D_initFields();
    return Axis3D$x_instance;
  }
  var Axis3D$y_instance;
  function Axis3D$y_getInstance() {
    Axis3D_initFields();
    return Axis3D$y_instance;
  }
  var Axis3D$z_instance;
  function Axis3D$z_getInstance() {
    Axis3D_initFields();
    return Axis3D$z_instance;
  }
  Axis3D.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Axis3D',
  ...
  function Axis3D$values() {
    return [Axis3D$x_getInstance(), Axis3D$y_getInstance(), Axis3D$z_getInstance()];
  }
  Axis3D.values = Axis3D$values;
  function Axis3D$valueOf(name) {
    switch (name) {
      case 'x':
        return Axis3D$x_getInstance();
      case 'y':
        return Axis3D$y_getInstance();
      case 'z':
        return Axis3D$z_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.generic.geometry.Axis3D.' + name);
    }
  }
  Axis3D.valueOf_61zpoe$ = Axis3D$valueOf;
  function AxisOrientation(name, ordinal, isFlipped) {
    Enum.call(this);
    this.isFlipped = isFlipped;
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function AxisOrientation_initFields() {
    AxisOrientation_initFields = function () {
    };
    AxisOrientation$euclidean_instance = new AxisOrientation('euclidean', 0, false);
    AxisOrientation$flipped_instance = new AxisOrientation('flipped', 1, true);
    AxisOrientation$Companion_getInstance();
  }
  var AxisOrientation$euclidean_instance;
  function AxisOrientation$euclidean_getInstance() {
    AxisOrientation_initFields();
    return AxisOrientation$euclidean_instance;
  }
  var AxisOrientation$flipped_instance;
  function AxisOrientation$flipped_getInstance() {
    AxisOrientation_initFields();
    return AxisOrientation$flipped_instance;
  }
  function AxisOrientation$Companion() {
    AxisOrientation$Companion_instance = this;
    this.default = AxisOrientation$euclidean_getInstance();
    this.inverted = AxisOrientation$flipped_getInstance();
  }
  AxisOrientation$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var AxisOrientation$Companion_instance = null;
  function AxisOrientation$Companion_getInstance() {
    AxisOrientation_initFields();
    if (AxisOrientation$Companion_instance === null) {
      new AxisOrientation$Companion();
    }
    return AxisOrientation$Companion_instance;
  }
  AxisOrientation.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AxisOrientation',
    interfaces: [Enum]
  };
  function AxisOrientation$values() {
    return [AxisOrientation$euclidean_getInstance(), AxisOrientation$flipped_getInstance()];
  }
  AxisOrientation.values = AxisOrientation$values;
  function AxisOrientation$valueOf(name) {
    switch (name) {
      case 'euclidean':
        return AxisOrientation$euclidean_getInstance();
      case 'flipped':
        return AxisOrientation$flipped_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.generic.geometry.AxisOrientation.' + name);
    }
  }
  AxisOrientation.valueOf_61zpoe$ = AxisOrientation$valueOf;
  function Oval() {
  }
  Oval.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'Oval',
    interfaces: [BezierPathConvertible]
  };
  function FractionOval(boundingRect) {
    FractionOval$Companion_getInstance();
    this.boundingRect_2op7ak$_0 = boundingRect;
    this.bezierPathValue_aqtxyj$_0 = lazy(FractionOval$bezierPathValue$lambda(this));
    this.topRightBezierSegment_flqb63$_0 = lazy(FractionOval$topRightBezierSegment$lambda(this));
    this.bottomRightBezierSegment_gm8nuh$_0 = lazy(FractionOval$bottomRightBezierSegment$lambda(this));
    this.bottomLeftBezierSegment_r6qq1i$_0 = lazy(FractionOval$bottomLeftBezierSegment$lambda(this));
    this.topLeftBezierSegment_y10z44$_0 = lazy(FractionOval$topLeftBezierSegment$lambda(this));
  }
  Object.defineProperty(FractionOval.prototype, 'boundingRect', {
    get: function () {
      return this.boundingRect_2op7ak$_0;
    }
  });
  function FractionOval$Companion() {
    FractionOval$Companion_instance = this;
    this.controlPointPercentDistanceForCircularCurve = 1.0 / 3.0 * (Math_0.sqrt(7.0) - 1.0);
  }
  FractionOval$Companion.prototype.controlPointDistanceForCircularCurveBetween_lu1900$ = function (a, b) {
    return a + (b - a) * this.controlPointPercentDistanceForCircularCurve;
  };
  FractionOval$Companion.prototype.boundingRectAroundCircle_n66hpt$ = function (radius, center) {
    return FractionRect_init(center.x - radius, center.y - radius, radius * 2, radius * 2);
  };
  FractionOval$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var FractionOval$Companion_instance = null;
  function FractionOval$Companion_getInstance() {
    if (FractionOval$Companion_instance === null) {
      new FractionOval$Companion();
    }
    return FractionOval$Companion_instance;
  }
  FractionOval.prototype.toBezierPath_0 = function () {
    return new BezierPath(listOf([this.topRightBezierSegment_0, this.bottomRightBezierSegment_0, this.bottomLeftBezierSegment_0, this.topLeftBezierSegment_0]));
  };
  Object.defineProperty(FractionOval.prototype, 'bezierPathValue', {
    get: function () {
      return this.bezierPathValue_aqtxyj$_0.value;
    }
  });
  Object.defineProperty(FractionOval.prototype, 'topRightBezierSegment_0', {
    get: function () {
      return this.topRightBezierSegment_flqb63$_0.value;
    }
  });
  Object.defineProperty(FractionOval.prototype, 'bottomRightBezierSegment_0', {
    get: function () {
      return this.bottomRightBezierSegment_gm8nuh$_0.value;
    }
  });
  Object.defineProperty(FractionOval.prototype, 'bottomLeftBezierSegment_0', {
    get: function () {
      return this.bottomLeftBezierSegment_r6qq1i$_0.value;
    }
  });
  Object.defineProperty(FractionOval.prototype, 'topLeftBezierSegment_0', {
    get: function () {
      return this.topLeftBezierSegment_y10z44$_0.value;
    }
  });
  function FractionOval$bezierPathValue$lambda(this$FractionOval) {
    return function () {
      return this$FractionOval.toBezierPath_0();
    };
  }
  function FractionOval$topRightBezierSegment$lambda(this$FractionOval) {
    return function () {
      return ellipticPerpendicularCurve(CubicBezierPathSegment$Companion_getInstance(), this$FractionOval.boundingRect.midXminY, this$FractionOval.boundingRect.maxXmidY, true);
    };
  }
  function FractionOval$bottomRightBezierSegment$lambda(this$FractionOval) {
    return function () {
      return ellipticPerpendicularCurve(CubicBezierPathSegment$Companion_getInstance(), this$FractionOval.boundingRect.maxXmidY, this$FractionOval.boundingRect.midXmaxY, true);
    };
  }
  function FractionOval$bottomLeftBezierSegment$lambda(this$FractionOval) {
    return function () {
      return ellipticPerpendicularCurve(CubicBezierPathSegment$Companion_getInstance(), this$FractionOval.boundingRect.midXmaxY, this$FractionOval.boundingRect.minXmidY, true);
    };
  }
  function FractionOval$topLeftBezierSegment$lambda(this$FractionOval) {
    return function () {
      return ellipticPerpendicularCurve(CubicBezierPathSegment$Companion_getInstance(), this$FractionOval.boundingRect.minXmidY, this$FractionOval.boundingRect.midXminY, true);
    };
  }
  FractionOval.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FractionOval',
    interfaces: [Oval]
  };
  function FractionOval_init(circularRadius, center, $this) {
    $this = $this || Object.create(FractionOval.prototype);
    FractionOval.call($this, FractionOval$Companion_getInstance().boundingRectAroundCircle_n66hpt$(circularRadius, center));
    return $this;
  }
  function ellipticPerpendicularCurve($receiver, start, end, clockwise) {
    var horizontalFirst = clockwise === (start.x < end.x === start.y < end.y);
    var xControlPoint = FractionOval$Companion_getInstance().controlPointDistanceForCircularCurveBetween_lu1900$(start.x, end.x);
    var yControlPoint = FractionOval$Companion_getInstance().controlPointDistanceForCircularCurveBetween_lu1900$(start.y, end.y);
    return horizontalFirst ? new CubicBezierPathSegment(start, new FractionPoint(xControlPoint, start.y), new FractionPoint(end.x, yControlPoint), end) : new CubicBezierPathSegment(start, new FractionPoint(start.x, yControlPoint), new FractionPoint(xControlPoint, end.y), end);
  }
  function UIAnchor(xOffset, yOffset) {
    UIAnchor$Companion_getInstance();
    this.xOffset = xOffset;
    this.yOffset = yOffset;
  }
  function UIAnchor$minXminY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
    UIAnchor.call(this, xOffset, yOffset);
  }
  UIAnchor$minXminY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'minXminY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$midXminY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$midXminY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'midXminY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$maxXminY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$maxXminY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'maxXminY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$minXmidY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$minXmidY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'minXmidY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$midXmidY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$midXmidY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'midXmidY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$maxXmidY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$maxXmidY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'maxXmidY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$minXmaxY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$minXmaxY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'minXmaxY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$midXmaxY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$midXmaxY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'midXmaxY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$maxXmaxY(xOffset, yOffset) {
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
  ...
  UIAnchor$maxXmaxY.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'maxXmaxY',
    interfaces: [UIAnchor]
  };
  function UIAnchor$Companion() {
    UIAnchor$Companion_instance = this;
    this.centerCenter = new UIAnchor$midXmidY(0.0, 0.0);
    this.origin = new UIAnchor$minXminY(0.0, 0.0);
  }
  UIAnchor$Companion.prototype.topLeft_cxy1xs$ = function (y, x, xOffset, yOffset) {
    if (y === void 0)
      y = AxisOrientation$euclidean_getInstance();
    if (x === void 0)
      x = AxisOrientation$euclidean_getInstance();
    if (xOffset === void 0)
      xOffset = 0.0;
    if (yOffset === void 0)
      yOffset = 0.0;
    switch (y.name) {
      case 'euclidean':
        switch (x.name) {
          case 'euclidean':
            return new UIAnchor$minXmaxY(xOffset, yOffset);
          case 'flipped':
            return new UIAnchor$maxXmaxY(xOffset, yOffset);
          default:return Kotlin.noWhenBranchMatched();
        }
      ...
      case 'flipped':
        switch (x.name) {
          case 'euclidean':
            return new UIAnchor$minXminY(xOffset, yOffset);
          case 'flipped':
            return new UIAnchor$maxXminY(xOffset, yOffset);
          default:return Kotlin.noWhenBranchMatched();
        }
  ...
  UIAnchor$Companion.prototype.topRight_cxy1xs$ = function (y, x, xOffset, yOffset) {
    if (y === void 0)
      y = AxisOrientation$euclidean_getInstance();
    if (x === void 0)
      x = AxisOrientation$euclidean_getInstance();
  ...
  UIAnchor$Companion.prototype.bottomLeft_cxy1xs$ = function (y, x, xOffset, yOffset) {
    if (y === void 0)
      y = AxisOrientation$euclidean_getInstance();
    if (x === void 0)
      x = AxisOrientation$euclidean_getInstance();
  ...
  UIAnchor$Companion.prototype.bottomRight_cxy1xs$ = function (y, x, xOffset, yOffset) {
    if (y === void 0)
      y = AxisOrientation$euclidean_getInstance();
    if (x === void 0)
      x = AxisOrientation$euclidean_getInstance();
  ...
  UIAnchor$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var UIAnchor$Companion_instance = null;
  function UIAnchor$Companion_getInstance() {
    if (UIAnchor$Companion_instance === null) {
      new UIAnchor$Companion();
    }
    return UIAnchor$Companion_instance;
  }
  UIAnchor.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UIAnchor',
  ...
  function UISize(name, ordinal) {
    Enum.call(this);
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function UISize_initFields() {
    UISize_initFields = function () {
    };
    UISize$large_instance = new UISize('large', 0);
    UISize$normal_instance = new UISize('normal', 1);
    UISize$small_instance = new UISize('small', 2);
  }
  var UISize$large_instance;
  function UISize$large_getInstance() {
    UISize_initFields();
    return UISize$large_instance;
  }
  var UISize$normal_instance;
  function UISize$normal_getInstance() {
    UISize_initFields();
    return UISize$normal_instance;
  }
  var UISize$small_instance;
  function UISize$small_getInstance() {
    UISize_initFields();
    return UISize$small_instance;
  }
  UISize.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UISize',
  ...
  function UISize$values() {
    return [UISize$large_getInstance(), UISize$normal_getInstance(), UISize$small_getInstance()];
  }
  UISize.values = UISize$values;
  function UISize$valueOf(name) {
    switch (name) {
      case 'large':
        return UISize$large_getInstance();
      case 'normal':
        return UISize$normal_getInstance();
      case 'small':
        return UISize$small_getInstance();
      default:throwISE('No enum constant org.bh.tools.ui.generic.UISize.' + name);
    }
  }
  UISize.valueOf_61zpoe$ = UISize$valueOf;
  function UIColor(nativeValue) {
    this.nativeValue_92yy42$_0 = nativeValue;
  }
  Object.defineProperty(UIColor.prototype, 'nativeValue', {
    get: function () {
      return this.nativeValue_92yy42$_0;
    }
  });
  UIColor.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function UIColorUsage(name) {
    UIColorUsage$Companion_getInstance();
    this.name = name;
  }
  function UIColorUsage$Companion() {
    UIColorUsage$Companion_instance = this;
    this.foreground = new UIColorUsage('foreground');
    this.background = new UIColorUsage('background');
  }
  Object.defineProperty(UIColorUsage$Companion.prototype, 'text', {
    get: defineInlineFunction('Decision-Cruncher.org.bh.tools.ui.visualization.UIColorUsage.Companion.get_text', function () {
      return this.foreground;
    })
  });
  UIColorUsage$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var UIColorUsage$Companion_instance = null;
  function UIColorUsage$Companion_getInstance() {
    if (UIColorUsage$Companion_instance === null) {
      new UIColorUsage$Companion();
    }
    return UIColorUsage$Companion_instance;
  }
  UIColorUsage.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UIColorUsage',
    interfaces: []
  };
  function UIPresentation(isEnabled, isVisible, colors) {
    UIPresentation$Companion_getInstance();
    this.isEnabled = isEnabled;
    this.isVisible = isVisible;
    this.colors = colors;
  }
  function UIPresentation$Companion() {
    UIPresentation$Companion_instance = this;
    this.default = new UIPresentation(true, true, emptyMap());
  }
  UIPresentation$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var UIPresentation$Companion_instance = null;
  function UIPresentation$Companion_getInstance() {
    if (UIPresentation$Companion_instance === null) {
      new UIPresentation$Companion();
    }
    return UIPresentation$Companion_instance;
  }
  UIPresentation.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UIPresentation',
    interfaces: []
  };
  ...
  var jq = defineInlineFunction('Decision-Cruncher.jQueryInterface.jq_mpjmqy$', wrapFunction(function () {
    var jq = $;
    return function (cssSelector) {
      return jq(cssSelector.cssSelectorString);
    };
  }));
  var jq_0 = defineInlineFunction('Decision-Cruncher.jQueryInterface.jq_s5y4k7$', wrapFunction(function () {
    var jq = $;
    return function (cssSelector, context) {
      return jq(cssSelector.cssSelectorString, context);
    };
  }));
  var jq_1 = defineInlineFunction('Decision-Cruncher.jQueryInterface.jq_vybnc7$', wrapFunction(function () {
    var jq = $;
    return function (cssSelector, context) {
      return jq(cssSelector.cssSelectorString, context);
    };
  }));
  var jq_2 = defineInlineFunction('Decision-Cruncher.jQueryInterface.jq_96tgg0$', wrapFunction(function () {
    var jq = $;
    return function (cssSelector, context) {
  ...
  var get_jq = defineInlineFunction('Decision-Cruncher.jQueryInterface.get_jq_6b7yl5$', wrapFunction(function () {
    var jq = $;
    return function ($receiver) {
      return jq($receiver.cssSelectorString);
    };
  }));
  var addClass = defineInlineFunction('Decision-Cruncher.jQueryInterface.addClass_k3zdg7$', function ($receiver, class_0) {
    return $receiver.addClass(class_0.className);
  });
  var removeClass = defineInlineFunction('Decision-Cruncher.jQueryInterface.removeClass_k3zdg7$', function ($receiver, class_0) {
    return $receiver.removeClass(class_0.className);
  });
  var data = defineInlineFunction('Decision-Cruncher.jQueryInterface.data_2sic0g$', function ($receiver, data) {
    return $receiver.data(data.dataName);
  });
  var data_0 = defineInlineFunction('Decision-Cruncher.jQueryInterface.data_qvjs58$', function ($receiver, data, value) {
    return $receiver.data(data.dataName, value);
  });
  var attr = defineInlineFunction('Decision-Cruncher.jQueryInterface.attr_65k86o$', function ($receiver, attribute) {
    return $receiver.attr(attribute.htmlAttributeName);
  });
  var attr_0 = defineInlineFunction('Decision-Cruncher.jQueryInterface.attr_f9h57c$', function ($receiver, attribute, value) {
    return $receiver.attr(attribute.htmlAttributeName, value);
  });
  var attr_1 = defineInlineFunction('Decision-Cruncher.jQueryInterface.attr_cakwrn$', function ($receiver, attribute, value) {
    return $receiver.attr(attribute.htmlAttributeName, value);
  });
  var attr_2 = defineInlineFunction('Decision-Cruncher.jQueryInterface.attr_2w9kpv$', function ($receiver, attribute, value) {
    return $receiver.attr(attribute.htmlAttributeName, value);
  });
  ...
  var package$shim = package$base.shim || (package$base.shim = {});
  package$shim.Throws = Throws;
  package$shim.ArithmeticException = ArithmeticException;
  package$shim.JvmStatic = JvmStatic;
  package$shim.assert_87ejdh$ = assert;
  ...
  package$math.get_fractionValue_rtoihn$ = get_fractionValue_3;
  ...
  package$geometry.get_integerValue_7lawu2$ = get_integerValue;
  package$geometry.integerValue_mm6051$ = integerValue;
  ...
  package$geometry.get_fractionValue_7lawu2$ = get_fractionValue;
  ...
  package$geometry.get_integerValue_vrtnvu$ = get_integerValue_0;
  ...
  package$geometry.get_integerValue_or5298$ = get_integerValue_1;
  package$geometry.integerValue_q2vt5p$ = integerValue_0;
  package$geometry.get_fractionValue_or5298$ = get_fractionValue_0;
  ...
  package$geometry.get_integerValue_jjbd33$ = get_integerValue_2;
  ...
  package$geometry.get_fractionValue_jjbd33$ = get_fractionValue_1;
  ...
  package$geometry.get_integerValue_s6phli$ = get_integerValue_3;
  package$geometry.get_fractionValue_6z9w7d$ = get_fractionValue_2;
  ...
  package$math.get_fractionValue_yrwdxr$ = get_fractionValue_4;
  ...
  package$math.toInt8Checked_mz3mee$ = toInt8Checked_0;
  package$math.toInt8Checked_5vcgdc$ = toInt8Checked_1;
  package$math.toInt8Checked_s8ev3n$ = toInt8Checked_2;
  package$math.toInt8Checked_mts6qi$ = toInt8Checked_3;
  ...
  package$math.toInt16Checked_5vcgdc$ = toInt16Checked_0;
  package$math.toInt16Checked_mz3mee$ = toInt16Checked_1;
  package$math.toInt16Checked_s8ev3n$ = toInt16Checked_2;
  package$math.toInt16Checked_mts6qi$ = toInt16Checked_3;
  ...
  package$math.toInt32Checked_s8ev3n$ = toInt32Checked_0;
  package$math.toInt32Checked_mz3mee$ = toInt32Checked_1;
  package$math.toInt32Checked_5vcgdc$ = toInt32Checked_2;
  package$math.toInt32Checked_mts6qi$ = toInt32Checked_3;
  ...
  package$math.toInt64Checked_mts6qi$ = toInt64Checked_0;
  package$math.toInt64Checked_mz3mee$ = toInt64Checked_1;
  package$math.toInt64Checked_5vcgdc$ = toInt64Checked_2;
  package$math.toInt64Checked_s8ev3n$ = toInt64Checked_3;
  package$math.toInteger_mts6qi$ = toInteger;
  package$math.toInteger_rtoihn$ = toInteger_0;
  package$math.toFloat32_81szk$ = toFloat32;
  package$math.toFloat32_rtoihn$ = toFloat32_0;
  package$math.toFloat64_yrwdxr$ = toFloat64;
  package$math.toFloat64_rtoihn$ = toFloat64_0;
  package$math.toFraction_yrwdxr$ = toFraction;
  package$math.toFraction_rtoihn$ = toFraction_0;
  ...
  package$math.toInteger_baug4k$ = toInteger_1;
  package$math.toFloat32_pdl1vz$ = toFloat32_1;
  package$math.toFloat64_pdl1vz$ = toFloat64_1;
  package$math.toFraction_pdl1vz$ = toFraction_1;
  ...
  package$math.get_integerValue_rtoihn$ = get_integerValue_4;
  package$math.get_integerValue_mts6qi$ = get_integerValue_5;
  package$math.integerValue_lt49qk$ = integerValue_1;
  package$math.integerValue_qll82d$ = integerValue_2;
  package$math.integerValue_m147bj$ = integerValue_3;
  package$math.integerValue_abkzxe$ = integerValue_4;
  package$math.integerValue_iqw0eh$ = integerValue_5;
  ...
  package$math.get_integerValue_964n91$ = get_integerValue_6;
  package$math.get_integerValue_i2lc79$ = get_integerValue_7;
  package$math.get_integerValue_tmsbgo$ = get_integerValue_8;
  package$math.get_integerValue_se6h4x$ = get_integerValue_9;
  ...
  package$math.get_fractionValue_rjqryz$ = get_fractionValue_5;
  package$math.get_fractionValue_bvy38s$ = get_fractionValue_6;
  ...
  package$jsShim.AnyCssSelector = AnyCssSelector;
  package$jsShim.CssHtmlAttribute = CssHtmlAttribute;
  package$jsShim.CssHtmlAttributeWithValue = CssHtmlAttributeWithValue;
  ...
  package$jsShim.CssParameterForAttributeSelector = CssParameterForAttributeSelector;
  package$jsShim.CssElement = CssElement;
  package$jsShim.CssClass = CssClass;
  package$jsShim.CssId = CssId;
  package$jsShim.DataAttribute = DataAttribute;
  ...
  package$jsShim.SelectorCombiner = SelectorCombiner;
  package$jsShim.or_ao9li5$ = or;
  package$jsShim.containing_ao9li5$ = containing;
  package$jsShim.justBefore_ao9li5$ = justBefore;
  package$jsShim.before_ao9li5$ = before;
  ...
  Object.defineProperty(AlertOption, 'close', {
    get: AlertOption$close_getInstance
  });
  Object.defineProperty(AlertOption, 'yes', {
    get: AlertOption$yes_getInstance
  });
  Object.defineProperty(AlertOption, 'no', {
    get: AlertOption$no_getInstance
  });
  Object.defineProperty(AlertOption, 'cancel', {
    get: AlertOption$cancel_getInstance
  });
  Object.defineProperty(AlertOption, 'ok', {
    get: AlertOption$ok_getInstance
  });
  var package$alert = package$ui.alert || (package$ui.alert = {});
  package$alert.AlertOption = AlertOption;
  package$alert.UserPrompt = UserPrompt;
  Object.defineProperty(HuskyOptionPaneOptionType, 'default', {
    get: HuskyOptionPaneOptionType$default_getInstance
  });
  Object.defineProperty(HuskyOptionPaneOptionType, 'yesNo', {
    get: HuskyOptionPaneOptionType$yesNo_getInstance
  });
  Object.defineProperty(HuskyOptionPaneOptionType, 'yesNoCancel', {
    get: HuskyOptionPaneOptionType$yesNoCancel_getInstance
  });
  Object.defineProperty(HuskyOptionPaneOptionType, 'okCancel', {
    get: HuskyOptionPaneOptionType$okCancel_getInstance
  });
  Object.defineProperty(HuskyOptionPaneOptionType, 'ok', {
    get: HuskyOptionPaneOptionType$ok_getInstance
  });
  package$alert.HuskyOptionPaneOptionType = HuskyOptionPaneOptionType;
  Object.defineProperty(HuskyOptionPaneMessageType, 'plain', {
    get: HuskyOptionPaneMessageType$plain_getInstance
  });
  Object.defineProperty(HuskyOptionPaneMessageType, 'info', {
    get: HuskyOptionPaneMessageType$info_getInstance
  });
  Object.defineProperty(HuskyOptionPaneMessageType, 'question', {
    get: HuskyOptionPaneMessageType$question_getInstance
  });
  Object.defineProperty(HuskyOptionPaneMessageType, 'warning', {
    get: HuskyOptionPaneMessageType$warning_getInstance
  });
  Object.defineProperty(HuskyOptionPaneMessageType, 'error', {
    get: HuskyOptionPaneMessageType$error_getInstance
  });
  package$alert.HuskyOptionPaneMessageType = HuskyOptionPaneMessageType;
  var package$events = package$ui.events || (package$ui.events = {});
  package$events.UIEvent = UIEvent;
  var package$generic = package$ui.generic || (package$ui.generic = {});
  var package$geometry_0 = package$generic.geometry || (package$generic.geometry = {});
  package$geometry_0.Axis = Axis;
  Object.defineProperty(Axis1D, 'x', {
    get: Axis1D$x_getInstance
  });
  package$geometry_0.Axis1D = Axis1D;
  Object.defineProperty(Axis2D, 'x', {
    get: Axis2D$x_getInstance
  });
  Object.defineProperty(Axis2D, 'y', {
    get: Axis2D$y_getInstance
  });
  package$geometry_0.Axis2D = Axis2D;
  Object.defineProperty(Axis3D, 'x', {
    get: Axis3D$x_getInstance
  });
  Object.defineProperty(Axis3D, 'y', {
    get: Axis3D$y_getInstance
  });
  Object.defineProperty(Axis3D, 'z', {
    get: Axis3D$z_getInstance
  });
  package$geometry_0.Axis3D = Axis3D;
  Object.defineProperty(AxisOrientation, 'euclidean', {
    get: AxisOrientation$euclidean_getInstance
  });
  Object.defineProperty(AxisOrientation, 'flipped', {
    get: AxisOrientation$flipped_getInstance
  });
  Object.defineProperty(AxisOrientation, 'Companion', {
    get: AxisOrientation$Companion_getInstance
  });
  package$geometry_0.AxisOrientation = AxisOrientation;
  package$geometry_0.Oval = Oval;
  Object.defineProperty(FractionOval, 'Companion', {
    get: FractionOval$Companion_getInstance
  });
  package$geometry_0.FractionOval_init_n66hpt$ = FractionOval_init;
  package$geometry_0.FractionOval = FractionOval;
  package$geometry_0.ellipticPerpendicularCurve_o5o7x7$ = ellipticPerpendicularCurve;
  UIAnchor.minXminY = UIAnchor$minXminY;
  UIAnchor.midXminY = UIAnchor$midXminY;
  UIAnchor.maxXminY = UIAnchor$maxXminY;
  UIAnchor.minXmidY = UIAnchor$minXmidY;
  UIAnchor.midXmidY = UIAnchor$midXmidY;
  UIAnchor.maxXmidY = UIAnchor$maxXmidY;
  UIAnchor.minXmaxY = UIAnchor$minXmaxY;
  UIAnchor.midXmaxY = UIAnchor$midXmaxY;
  UIAnchor.maxXmaxY = UIAnchor$maxXmaxY;
  Object.defineProperty(UIAnchor, 'Companion', {
    get: UIAnchor$Companion_getInstance
  });
  package$generic.UIAnchor = UIAnchor;
  Object.defineProperty(UISize, 'large', {
    get: UISize$large_getInstance
  });
  Object.defineProperty(UISize, 'normal', {
    get: UISize$normal_getInstance
  });
  Object.defineProperty(UISize, 'small', {
    get: UISize$small_getInstance
  });
  package$generic.UISize = UISize;
  var package$visualization = package$ui.visualization || (package$ui.visualization = {});
  package$visualization.UIColor = UIColor;
  Object.defineProperty(UIColorUsage, 'Companion', {
    get: UIColorUsage$Companion_getInstance
  });
  package$visualization.UIColorUsage = UIColorUsage;
  Object.defineProperty(UIPresentation, 'Companion', {
    get: UIPresentation$Companion_getInstance
  });
  package$visualization.UIPresentation = UIPresentation;
  ...
  package$jQueryInterface.jq_mpjmqy$ = jq;
  package$jQueryInterface.jq_s5y4k7$ = jq_0;
  package$jQueryInterface.jq_vybnc7$ = jq_1;
  package$jQueryInterface.get_jq_6b7yl5$ = get_jq;
  package$jQueryInterface.jq_96tgg0$ = jq_2;
  package$jQueryInterface.addClass_k3zdg7$ = addClass;
  package$jQueryInterface.removeClass_k3zdg7$ = removeClass;
  package$jQueryInterface.data_2sic0g$ = data;
  package$jQueryInterface.data_qvjs58$ = data_0;
  package$jQueryInterface.attr_65k86o$ = attr;
  package$jQueryInterface.attr_f9h57c$ = attr_0;
  package$jQueryInterface.attr_cakwrn$ = attr_1;
  package$jQueryInterface.attr_2w9kpv$ = attr_2;
  ...
  DataAttribute.prototype.cssSelectorString_qyu2k8$ = CssHtmlAttributeWithValue.prototype.cssSelectorString_qyu2k8$;
  ...
  Object.defineProperty(Oval.prototype, 'b\xE9zierPathValue', Object.getOwnPropertyDescriptor(BezierPathConvertible.prototype, 'b\xE9zierPathValue'));
  Object.defineProperty(FractionOval.prototype, 'b\xE9zierPathValue', Object.getOwnPropertyDescriptor(Oval.prototype, 'b\xE9zierPathValue'));
  notFound = null;
